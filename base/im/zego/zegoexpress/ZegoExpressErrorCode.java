...
final public class ZegoExpressErrorCode {
    ...
    final static public int CommonIllegalParam = 1000017;
    ...
    final static public int CommonCdnUrlTooLong = 1000018;
    ...
    final static public int CommonCdnAuthParamTooLong = 1000019;
    ...
    final static public int CommonUserNotSame = 1000020;
    ...
    final static public int CommonAppAccessDeniedError = 1000039;
    ...
    final static public int CommonConfigAfterEngineStarted = 1000066;
    ...
    final static public int CommonConfigAfterRoomLoggedIn = 1000067;
    ...
    final static public int CommonLoadLibraryFailed = 1000070;
    ...
    final static public int CommonLoadLibraryFuncNotFound = 1000071;
    ...
    final static public int CommonLoadLibraryNotSupport = 1000072;
    ...
    final static public int EngineLicenseNull = 1001006;
    ...
    final static public int EngineSetRoomModeErrorTime = 1001020;
    ...
    final static public int EngineSetGeoFenceErrorTime = 1001021;
    ...
    final static public int EngineExperimentalJsonStrInvalid = 1001091;
    ...
    final static public int RoomRoomidIncorrect = 1002002;
    ...
    final static public int RoomRoomExtraInfoKeyEmpty = 1002014;
    ...
    final static public int RoomRoomExtraInfoKeyTooLong = 1002015;
    ...
    final static public int RoomRoomExtraInfoValueTooLong = 1002016;
    ...
    final static public int RoomRoomExtraInfoExceedKeys = 1002017;
    ...
    final static public int RoomMultiRoomLoginUserNotSame = 1002018;
    ...
    final static public int RoomMultiRoomSwtichRoomInvalid = 1002019;
    ...
    final static public int RoomErrorExceedMaximumRoomCount = 1002035;
    ...
    final static public int RoomErrorLoginMultiRoomNotOpen = 1002036;

    /** The total number of rooms logged in at the same time exceeds the limit, Please contact ZEGO technical support. */
    final static public int RoomErrorMultiRoomExceedMaximumRoomCount = 1002037;
    ...
    final static public int RoomTokenExpiredKickedOut = 1002056;
    ...
    final static public int RoomSessionExceptionKickedOut = 1002057;
    ...
    final static public int RoomWrongLoginSequence = 1002061;
    ...
    final static public int RoomWrongLogoutSequence = 1002062;
    ...
    final static public int RoomNoMultiRoomPermission = 1002063;
    ...
    final static public int RoomRoomIdHasBeenUsed = 1002064;
    ...
    final static public int RoomMultiRoomDeprecated = 1002065;
    ...
    final static public int RoomUserInBlacklist = 1002066;
    ...
    final static public int RoomNoToken = 1002067;
    ...
    final static public int RoomAppCallApiTooFrequent = 1002071;
    ...
    final static public int RoomRoomCallApiTooFrequent = 1002072;
    ...
    final static public int RoomAppCallTooFrequent = 1002073;
    ...
    final static public int RoomTokenInnerError = 1002074;
    ...
    final static public int RoomTokenFormatError = 1002075;
    ...
    final static public int RoomTokenAppidError = 1002076;
    ...
    final static public int RoomTokenUseridError = 1002077;
    ...
    final static public int RoomTokenExpireError = 1002078;
    ...
    final static public int RoomTokenVersionError = 1002079;
    ...
    final static public int RoomTokenNoncetypeError = 1002080;
    ...
    final static public int RoomMultiRoomRequired = 1002081;
    ...
    final static public int RoomRenewTokenNoPublishAuthError = 1002082;
    ...
    final static public int RoomRoomLoginCustomDataLengthError = 1002083;
    ...
    final static public int RoomRoomLoginLicenseNotFound = 1002084;
    ...
    final static public int RoomRoomLoginLicenseExpired = 1002085;

    /** Description: The user has logged in elsewhere.  <br>Solutions:  Check whether the user has logged in elsewhere. */
    final static public int RoomRoomLoginOther = 1002086;
    ...
    final static public int RoomRoomLicenseFeatureLimit = 1002087;
    ...
    final static public int PublisherErrorH265EncoderNotSupported = 1003010;
    ...
    final static public int PublisherObjectSegmentationPerformanceWarning = 1003011;
    ...
    final static public int PublisherObjectSegmentationDeviceNotSupport = 1003012;
    ...
    final static public int PublisherObjectSegmentationNoAuth = 1003013;
    ...
    final static public int PublisherObjectSegmentationParamError = 1003014;
    ...
    final static public int PublisherObjectSegmentationImageLoadError = 1003015;
    ...
    final static public int PublisherErrorRetryTimeout = 1003021;
    ...
    final static public int PublisherTakePublishStreamSnapshotFailed = 1003030;
    ...
    final static public int PublisherAudioSideDataNull = 1003045;
    ...
    final static public int PublisherAudioSideDataTooLong = 1003046;
    ...
    final static public int PublisherEncryptionKeyInvalid = 1003060;
    ...
    final static public int PublisherErrorPublishWhenUsingMultiRoom = 1003070;
    ...
    final static public int PublisherErrorPublishWithRoomIdIsNullWhenUsingMultiRoom = 1003071;
    ...
    final static public int PublisherErrorDispatchAuthError = 1003072;
    ...
    final static public int PublisherDummyCaptureImagePathError = 1003073;
    ...
    final static public int PublisherVideoEncoderNoSupportted = 1003080;

    /** Description: Video encoder error.<br>Caution: Video encoder error.<br>Solutions: Please contact ZEGO technical support. */
    final static public int PublisherVideoEncoderFail = 1003081;
    ...
    final static public int PlayerPlayStreamNotExist = 1004002;
    ...
    final static public int PlayerErrorDispatchAuthError = 1004003;
    ...
    final static public int PlayerSuperResolutionDeviceNotSupport = 1004004;
    ...
    final static public int PlayerSuperResolutionMaxCountExceed = 1004005;
    ...
    final static public int PlayerSuperResolutionVideoSizeNotSupport = 1004006;
    ...
    final static public int PlayerSuperResolutionDevicePerformanceError = 1004007;
    ...
    final static public int PlayerSuperResolutionNotInitError = 1004008;
    ...
    final static public int PlayerStreamWasNotPlayed = 1004011;
    ...
    final static public int PlayerErrorServerForbid = 1004025;
    ...
    final static public int PlayerTakePlayStreamSnapshotFailed = 1004030;
    ...
    final static public int PlayerDecryptionKeyInvalid = 1004060;
    ...
    final static public int PlayerDecryptionFailed = 1004061;
    ...
    final static public int PlayerErrorPlayStreamWhenUsingMultiRoom = 1004070;
    ...
    final static public int PlayerErrorPlayStreamWithRoomIdIsNullWhenUsingMultiRoom = 1004071;
    ...
    final static public int PlayerNotConfigL3 = 1004072;
    ...
    final static public int PlayerVideoDecoderNoSupportted = 1004080;

    /** Description: Video decoder fail.<br>Caution: Video decoder fail.<br>Solutions: Please contact ZEGO technical support. */
    final static public int PlayerVideoDecoderFail = 1004081;
    ...
    final static public int MixerInputLabelTextTooLong = 1005028;
    ...
    final static public int MixerOutputTargetTooLongError = 1005029;
    ...
    final static public int MixerExceedMaxAudioFocusStreamCount = 1005031;
    ...
    final static public int MixerAdvancedConfigTooLongError = 1005032;
    ...
    final static public int MixerWatermarkTooLong = 1005033;
    ...
    final static public int MixerInputImageUrlTooLong = 1005034;
    ...
    final static public int MixerInputImageUrlFormatError = 1005035;
    ...
    final static public int MixerInputImageUrlSizeError = 1005036;
    ...
    final static public int MixerOutputTargetRoomError = 1005037;
    ...
    final static public int MixerBackgroundImageUrlTooLong = 1005066;
    ...
    final static public int MixerUserDataTooLong = 1005068;
    ...
    final static public int DeviceSouldLevelIntervalInvalid = 1006031;
    ...
    final static public int DeviceAudioSpectrumIntervalInvalid = 1006032;
    ...
    final static public int DeviceZoomFactorInvalid = 1006040;
    ...
    final static public int DeviceExposureCompensationValueInvalid = 1006041;

    /** invalid audio VAD monitor type */
    final static public int DeviceAudioVadStableStateMonitorTypeInvalid = 1006042;
    ...
    final static public int PreprocessReverbEchoParamNull = 1007017;
    ...
    final static public int PreprocessReverbEchoParamInvalid = 1007018;
    ...
    final static public int PreprocessElectronicEffectsTonalInvalid = 1007019;
    ...
    final static public int PreprocessEnableEffectsEnvFailed = 1007020;
    ...
    final static public int PreprocessEnableEffectsBeautyFailed = 1007021;
    ...
    final static public int PreprocessSetEffectsParamFailed = 1007022;
    ...
    final static public int PreprocessNotSupportEffectsBufferType = 1007023;
    ...
    final static public int PreprocessEnableSpeechEnhanceParamInvalid = 1007024;
    ...
    final static public int MediaPlayerFilePathTooLong = 1008004;
    ...
    final static public int MediaPlayerFileExpired = 1008009;
    ...
    final static public int MediaPlayerResourceExpired = 1008011;
    ...
    final static public int MediaPlayerResourceIdTooLong = 1008012;
    ...
    final static public int MediaPlayerUserCancel = 1008013;
    ...
    final static public int MediaPlayerAlreadyStart = 1008014;
    ...
    final static public int MediaPlayerSetAudioTrackIndexError = 1008040;
    ...
    final static public int MediaPlayerSetVoiceChangerParamInvalid = 1008041;
    ...
    final static public int MediaPlayerTakeSnapshotTimingError = 1008042;
    ...
    final static public int MediaPlayerParamValueRangeIllegal = 1008043;
    ...
    final static public int MediaPlayerLocalCacheFailed = 1008044;
    ...
    final static public int IMDataTooLong = 1009003;
    ...
    final static public int IMInconsistentRoomId = 1009005;
    ...
    final static public int IMUserIdEmpty = 1009011;
    ...
    final static public int IMUserIdTooLong = 1009012;
    ...
    final static public int IMInputParamsLengthLimit = 1009013;

    /** Description: Failed to send broadcast message,. <br>Cause: QPS exceeds the limit. <br>Solutions: Control the maximum QPS is 2 . */
    final static public int IMBroadcastMessageQpsOverload = 1009015;
    ...
    final static public int IMManagerCreationFailed = 1009031;
    ...
    final static public int IMNoManagerInstance = 1009032;
    ...
    final static public int IMNoAvailableBroadcastChannel = 1009033;
    ...
    final static public int IMNoAvailableStreamId = 1009034;
    ...
    final static public int IMRepeatBroadcast = 1009035;
    ...
    final static public int IMNoBroadcatingStream = 1009036;
    ...
    final static public int IMNoSubscribingStream = 1009037;
    ...
    final static public int IMRepeatSubscribe = 1009038;
    ...
    final static public int IMRealTimeSequentialDataSendFailed = 1009039;
    ...
    final static public int CustomVideoIOProcessModuleNotCreated = 1011004;
    ...
    final static public int CustomVideoIONoCustomVideoProcessing = 1011005;
    ...
    final static public int CustomVideoIOInvalidActiveD3d11Device = 1011012;
    ...
    final static public int CustomAudioIOAudioDataCallbackSampleRateNoSupport = 1012010;
    ...
    final static public int MediaDataPublisherNoInstance = 1013000;

    /** Description: This error code is deprecated. <br>Cause: None. <br> Solutions: None. */
    final static public int MediaDataPublisherFileParseError = 1013001;

    /** Description: This error code is deprecated. <br>Cause: None. <br> Solutions: None. */
    final static public int MediaDataPublisherFilePathError = 1013002;
    ...
    final static public int MediaDataPublisherFileCodecError = 1013003;
    ...
    final static public int MediaDataPublisherTimestampGoBackError = 1013004;
    ...
    final static public int MediaDataPublisherExceedMaxCount = 1013005;
    ...
    final static public int AudioEffectPlayerNoInstance = 1014000;
    ...
    final static public int AudioEffectPlayerLoadFailed = 1014001;
    ...
    final static public int AudioEffectPlayerPlayFailed = 1014002;
    ...
    final static public int AudioEffectPlayerSeekFailed = 1014003;
    ...
    final static public int AudioEffectPlayerExceedMaxCount = 1014004;
    ...
    final static public int UtilitiesNetworkConnectivityTestFailed = 1015001;
    ...
    final static public int UtilitiesNetworkToolConnectServerFailed = 1015002;
    ...
    final static public int UtilitiesNetworkToolRtpTimeoutError = 1015003;
    ...
    final static public int UtilitiesNetworkToolEngineDenied = 1015004;
    ...
    final static public int UtilitiesNetworkToolStoppedByPublishingStream = 1015005;
    ...
    final static public int UtilitiesNetworkToolStoppedByPlayingStream = 1015006;

    /** Description: Network speed test internal error. <br>Cause: Internal error. <br> Solutions: Please contact ZEGO technical support. */
    final static public int UtilitiesNetworkToolInnerError = 1015009;
    ...
    final static public int UtilitiesPerformanceMonitorIntervalInvalid = 1015031;
    ...
    final static public int UtilitiesStopByLoginRoom = 1015032;

    /** Description: Fail to dump data. <br>Cause: Error occurred in AV engine. <br>Solutions: Please contact ZEGO technical support. */
    final static public int UtilitiesStartDumpAudioDataFailed = 1015033;
    ...
    final static public int UtilitiesAlreadyStartDumpDataError = 1015034;

    /** Description: No dump data. <br>Cause: Error occurred in AV engine. <br>Solutions: Please contact ZEGO technical support. */
    final static public int UtilitiesNoDumpDataError = 1015035;
    ...
    final static public int UtilitiesCreateDumpDataFolderError = 1015036;
    ...
    final static public int UtilitiesUploadModuleInnerError = 1015037;
    ...
    final static public int UtilitiesDumpDataExceedMaxSizeError = 1015038;
    ...
    final static public int RangeAudioNoInstance = 1016000;
    ...
    final static public int RangeAudioExceedMaxCount = 1016001;
    ...
    final static public int RangeAudioNotSupportMultiRoom = 1016002;
    ...
    final static public int RangeAudioTeamIdTooLong = 1016003;
    ...
    final static public int RangeAudioTeamIdInvalidCharacter = 1016004;
    ...
    final static public int CopyrightedMusicCommandInvalid = 1017000;
    ...
    final static public int CopyrightedMusicParamsInvalid = 1017001;
    ...
    final static public int CopyrightedMusicSongIdInvalid = 1017002;
    ...
    final static public int CopyrightedMusicShareTokenInvalid = 1017003;
    ...
    final static public int CopyrightedMusicResourceIdInvalid = 1017004;
    ...
    final static public int CopyrightedMusicStartPositionInvalid = 1017005;
    ...
    final static public int CopyrightedMusicPositionInvalid = 1017006;
    ...
    final static public int CopyrightedMusicVolumeInvalid = 1017007;
    ...
    final static public int CopyrightedMusicKrcTokenInvalid = 1017008;
    ...
    final static public int CopyrightedMusicCopyrightedMusicAuthParamInvalid = 1017009;
    ...
    final static public int CopyrightedMusicCopyrightedServerFail = 1017010;
    ...
    final static public int CopyrightedMusicFreeSpaceLimit = 1017011;
    ...
    final static public int CopyrightedMusicDownloading = 1017012;

    /** Description: Resource file not exist. <br>Cause: Resource file has been deleted. <br>Solutions: Please reload resource. */
    final static public int CopyrightedMusicResourceFileNotExist = 1017013;
    ...
    final static public int CopyrightedMusicResourceFileExpired = 1017014;
    ...
    final static public int CopyrightedMusicResourceFileInvalid = 1017015;

    /** Description: Download canceled. <br>Cause: Call [cancelDownload] to actively cancel the download. */
    final static public int CopyrightedMusicDownloadCanceled = 1017016;
    ...
    final static public int CopyrightedMusicResourceIdUnauthorized = 1017018;
    ...
    final static public int CopyrightedMusicResourceExpired = 1017019;
    ...
    final static public int CopyrightedMusicResourceNotSupportFunction = 1017020;
    ...
    final static public int CopyrightedMusicNoCopyright = 1017030;
    ...
    final static public int CopyrightedMusicNoPermissionsOfLyricsAndMusic = 1017031;
    ...
    final static public int CopyrightedMusicIllegalParam = 1017040;
    ...
    final static public int CopyrightedMusicAppidInvalid = 1017041;

    /** Description: Billing mode invalid. <br>Cause: Billing mode invalid. <br>Solutions: Please select correct billing mode. */
    final static public int CopyrightedMusicBillingModeInvalid = 1017042;
    ...
    final static public int CopyrightedMusicUnreasonableAccess = 1017043;
    ...
    final static public int CopyrightedMusicShareTokenExpired = 1017044;
    ...
    final static public int CopyrightedMusicShareTokenIllegal = 1017045;
    ...
    final static public int CopyrightedMusicKrcTokenIllegal = 1017046;
    ...
    final static public int CopyrightedMusicKrcTokenExpired = 1017047;

    /** Description: Get lyric fail. <br>Cause: Lyrics not found. <br>Solutions: Please try again later. */
    final static public int CopyrightedMusicGetLyricFail = 1017048;

    /** Description: Get pitch fail. <br>Cause: Pitch not found. <br>Solutions: Please select correct song. */
    final static public int CopyrightedMusicGetPitchFail = 1017049;
    ...
    final static public int CopyrightedMusicNotSharedResource = 1017050;
    ...
    final static public int CopyrightedMusicGetSharedResourceTimesOver = 1017051;
    ...
    final static public int CopyrightedMusicVendorIdNotAvaliable = 1017052;
    ...
    final static public int CopyrightedMusicVendorNotSupportFunction = 1017053;
    ...
    final static public int CopyrightedMusicRoomNoLogin = 1017054;

    /** Description: Vendor ID invalid. <br>Cause: Wrong vendor selection. <br>Solutions: Please pass in the correct vendor ID. */
    final static public int CopyrightedMusicVendorIdInvalid = 1017071;
    ...
    final static public int CopyrightedMusicSongIdNotSupport = 1017072;
    ...
    final static public int CopyrightedMusicMasterIdInvalid = 1017073;
    ...
    final static public int CopyrightedMusicPageInvalid = 1017074;

    /** Description: resource has no pitch. <br>Cause: resource has no pitch. <br>Solutions: Please pass in the correct song ID. */
    final static public int CopyrightedMusicNoPitch = 1017075;
    ...
    final static public int CopyrightedMusicSceneIdInvalid = 1017076;
    ...
    final static public int CopyrightedMusicTopIdInvalid = 1017077;
    ...
    final static public int CopyrightedMusicLoadPluginFail = 1017094;
    ...
    final static public int CopyrightedMusicNotSupportMethod = 1017095;
    ...
    final static public int CopyrightedMusicNoInit = 1017096;

    /** Description: System is busy. <br>Cause: System is busy. <br>Solutions: Please try again. */
    final static public int CopyrightedMusicSystemBusy = 1017097;
    ...
    final static public int CopyrightedMusicNetworkError = 1017098;
    ...
    final static public int CopyrightedMusicInnerError = 1017099;

    /** Description: SDK internal return null pointer. */
    final static public int AudioVADClientInnerNullptr = 1018000;
    ...
    final static public int AudioVADClientNoInstance = 1018001;
    ...
    final static public int RangeSceneCallFunctionFailed = 1019000;
    ...
    final static public int RangeSceneNoInstance = 1019001;

    /** Description: Not login scene. <br>Cause: Not login scene. <br> Solutions: Please call [loginScene] to login scene. */
    final static public int RangeSceneNotLoginScene = 1019002;
    ...
    final static public int RangeSceneNotSupport = 1019003;
    ...
    final static public int RangeSceneRetryTimeout = 1019004;
    ...
    final static public int RangeSceneNetworkInterrupt = 1019005;
    ...
    final static public int RangeSceneTokenIllegal = 1019006;

    /** Description: Token expire. <br>Cause: Token expire or the generated Token validity period parameter type is incorrect. <br>Solutions: Regenerate the Token. */
    final static public int RangeSceneTokenExpire = 1019007;
    ...
    final static public int RangeSceneCoordinateOutOfRange = 1019020;
    ...
    final static public int RangeSceneItemHasBeenCreated = 1019021;
    ...
    final static public int RangeSceneItemCasFailed = 1019025;
    ...
    final static public int RangeSceneItemCapacityExceedLimit = 1019026;
    ...
    final static public int RangeSceneUserBindItemExceedLimit = 1019027;
    ...
    final static public int RangeSceneItemOutOfUserView = 1019028;
    ...
    final static public int RangeSceneExceedMaxCount = 1019030;
    ...
    final static public int RangeSceneTeamExceedMaxCount = 1019031;
    ...
    final static public int RangeSceneTeamIdOccupied = 1019032;
    ...
    final static public int RangeSceneTeamIdIncorrect = 1019033;

    /** Description: Failed due to internal system exceptions.<br>Cause: Unknown internal error.<br>Solutions: Contact ZEGO technical support to deal with it. */
    final static public int RangeSceneInnerError = 1019099;
    ...
    final static public int ScreenCapturePermissionDenied = 1020000;
    ...
    final static public int ScreenCaptureNotSupport = 1020001;
    ...
    final static public int ScreenCaptureSdkNoModule = 1020002;
    ...
    final static public int ScreenCaptureNoInstance = 1020003;
    ...
    final static public int ScreenCaptureExceedMaxCount = 1020004;

    /** Description: Failed due to internal system exceptions.<br>Cause: Unknown internal error.<br>Solutions: Contact ZEGO technical support to deal with it. */
    final static public int ScreenCaptureInnerError = 1020005;
    ...
    final static public int AIVoiceChangerNoInstance = 1021000;
    ...
    final static public int AIVoiceChangerExceedMaxCount = 1021001;

    /** Description: Failed due to internal system exceptions.<br>Cause: Unknown internal error.<br>Solutions: Contact ZEGO technical support to deal with it. */
    final static public int AIVoiceChangerInnerError = 1021002;
    ...
    final static public int AIVoiceChangerNotInitError = 1021003;
    ...
    final static public int AIVoiceChangerInitFailedError = 1021004;
    ...
    final static public int AIVoiceChangerNoModelError = 1021005;
    ...
    final static public int AIVoiceChangerModelDownloadFailedError = 1021006;
    ...
    final static public int AIVoiceChangerDeviceNotSupportedError = 1021007;
}
